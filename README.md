# Paybox CGI for Magento

The extension provides Paybox payment integration. Allows make payments through Paybox CGI methods.

**This module is only intended to be used by merchant having the CGI entry point.**
